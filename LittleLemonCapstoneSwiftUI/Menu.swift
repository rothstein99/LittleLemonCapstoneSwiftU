...
struct Menu: View {
    ...
    var body: some View {
        VStack {
            Text("Little Lemon")
            Text("Chicago")
            Text("Order delicious Mediterranean food.")
    ...
    // Sort dishes alphabetically by title
    ...
    func getMenuData() {
        ...
        let urlString = "https://raw.githubusercontent.com/Meta-Mobile-Developer-PC/Working-With-Data-API/main/api/menu.json"
